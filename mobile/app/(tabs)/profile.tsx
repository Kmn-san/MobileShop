...
const MENU_ITEMS = [
    ...
    { id: 2, icon: "list-outline", title: "Orders", color: "#10B981", action: "/ordeers" },
...
] as const // can't edit or update the data (read only)
            ...
            >
                ...
                <View className='flex-row flex-wrap gap-2 mx-6 mb-3'>
                    {MENU_ITEMS.map((item) => (
                        <TouchableOpacity
                            key={item.id}
                            className='bg-surface rounded-2xl p-6 items-center mb-4'
                            style={{ width: "48%" }}
                            activeOpacity={0.7}

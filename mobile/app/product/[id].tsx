...
const ProductDetialScreen = () => {
    ...
    const { isInWishlist, isAddingToWishlist, isRemovingFromWishlist, toggleWishlist } = useWishlist()
            ...
            >
                ...
                >
                    {isAddingToWishlist || isRemovingFromWishlist ? (
                        ...
                        <Ionicons
                            name={isInWishlist(product._id) ? "heart" : "heart-outline"} size={24}
...
export default ProductDetialScreen

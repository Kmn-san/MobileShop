...
import { FlatList, View, Text, TouchableOpacity, Image, ActivityIndicator, Alert } from 'react-native'
    ...
    >
      ...
      <View className='p-3'>
        ...
        <View className='flex-row items-center justify-between'>
          <Text className='text-primary font-bold text-lg'>RM {product.price.toFixed(2)}</Text>
          <TouchableOpacity
